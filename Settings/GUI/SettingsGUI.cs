...
namespace Fury.Settings.UI
{
    ...
    internal sealed partial class SettingsGUI : ISettingsGUIState
    {
        ...
        public void OnGUI()
        {
            ...
            _rowHeight = UnityEngine.GUI.skin.button.CalcHeight(GUIContent.none, 8);
            ...
            float width)
        {
            ...
            using (var scrollView = new GUILayout.ScrollViewScope(_scrollPosition, GUILayout.ExpandHeight(true)))
            {
                ...
                foreach (var key in group.Keys)
                {
                    ...
                    {
                        UnityEngine.GUI.enabled = enabledRev && key.Enabled;
        ...
        private void OnPageActionsGUILayout()
        {
            ...
            using (new GUILayout.HorizontalScope())
            {
                UnityEngine.GUI.enabled = enabledRev && _page.IsChanged;
                {
